...
from classflow.presentation.api.routers.address.router import address_router
from classflow.presentation.api.routers.attendance.router import (
    attendance_router,
)
...
from classflow.presentation.api.routers.payment.router import payment_router
from classflow.presentation.api.routers.subject.router import subject_router
from classflow.presentation.api.routers.user import user_router
