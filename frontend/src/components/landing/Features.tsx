...
const FEATURES = [
  {
    ...
    desc: 'Создайте уч��бный центр, добавьте адреса, кабинеты и настройте всё под свои нужды за несколько минут.',
  },
  {
  ...
  },
  {
    ...
    desc: 'Гибкая система ролей: Владелец, Администратор, Преподаватель, Ученик. Пригласите команду по email.',
  },
  {
