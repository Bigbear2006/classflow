...
import type { MyOrganization, Organization } from '../types.ts';
...
import type { CreateOrganizationData } from '../api/organizations/types.ts';
...
export function OrganizationsPage() {
  ...
  useEffect(() => {
    getOrganizations().then(setFoundOrgs);
